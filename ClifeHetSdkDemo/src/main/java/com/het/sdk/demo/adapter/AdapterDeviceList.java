...
public class AdapterDeviceList extends BaseAdapter {
    ...
    public AdapterDeviceList(List<DeviceModel> deviceModels,
                             Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.adapter_device_list_item,
                    null);
       ...
       String online=deviceModel.getOnlineStatus();
